// MENU DE COMPRAS AGENCIA DE AUTOS
...
switch (metodosDePago) {
  case "1":
    ...
    break;
    case "2":
    alert("Ya que elegiste pagar con transferencia bancaria se te sumará el porcentaje del IVA, que ni Massa te lo puede sacar");
